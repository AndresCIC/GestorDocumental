<template>
	<div id="Detail" class="container-fluid">
		<div id ="FormularioPlantillas" class="mx-auto" style="width: 45%">
			<center>
			...
			<div class="form-group">
				...
				<select v-model="plantilla.Permisos" class="form-control" :disabled="!isEditable">
			...
			<div class="col">
				<label>Extensión de email:</label>

				<input :disabled="!isEditable" class="form-control" type="text" v-model="plantilla.ExtCorreoE" id="creacionInput" ></input>
			</div>
			<div class="checkbox">
				<label>	<input :disabled="!isEditable" class="checkbox" type="checkbox" v-model="plantilla.Activo" id="modificableInput" >Activo</label>
			</div>
			<div class="form-group">
				<label>Descripción:</label>
				<textarea :disabled="!isEditable" class="form-control"  v-model="plantilla.Descripcion" rows="5" id="comment"></textarea>
			</div>
